...
namespace RockstarProj.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        protected string AdminURLGUID = ConfigurationManager.AppSettings["AdminUrlGUID"];
        protected string AdminLoginGUID = ConfigurationManager.AppSettings["AdminLoginGUID"];
        protected string AdminToolsGUID = ConfigurationManager.AppSettings["AdminToolsGUID"];
        ...
        /// <returns></returns>
        public ActionResult AdminTools(string GUID)
        {
        ...
        /// <summary>
        /// Blog entry post view
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult BlogEntry(BlogDataModel model)
        {
            BlogService svc = new BlogService();
            svc.CreateBlogEntry(model);
        ...
        /// <param name="GUID"></param>
        /// <returns></returns>
        public ActionResult ProfileTool(string GUID)
        {
            if (!(String.IsNullOrEmpty(GUID)) && GUID.Equals(AdminToolsGUID))
            {
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public ActionResult ProfileEntry(string GUID, int Id)
        {
            if (!(String.IsNullOrEmpty(GUID)) && GUID.Equals(AdminToolsGUID))
            {
                ProfileService svc = new ProfileService();
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult ProfileEntry(RockstarProfile model, HttpPostedFileBase file, HttpPostedFileBase popupFile)
        {
            ProfileService svc = new ProfileService();
            svc.CreateProfileEntry(model,file,popupFile);
            return Redirect("/Account/ProfileTool?GUID=" + AdminToolsGUID);
        }


        /// <summary>
        /// Delete profile entry view
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public ActionResult DeleteProfileEntry(int id)
        {
            ProfileService svc = new ProfileService();
            svc.DeleteBlogRecord(id);
            return Redirect("/Account/ProfileTool?GUID=" + AdminToolsGUID);
        ...
        public ActionResult Login(string GUID)
        {
            ...
            if (!(String.IsNullOrEmpty(GUID)) && GUID.Equals(AdminURLGUID))
            {
                return View();
            }
            else
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
                ...
                return Redirect("AdminTools?GUID=" + AdminToolsGUID);
            }
        ...
        public ActionResult LogOff()
        {
            ...
            return Redirect("/Account/Login?GUID=" + AdminURLGUID);
        }
